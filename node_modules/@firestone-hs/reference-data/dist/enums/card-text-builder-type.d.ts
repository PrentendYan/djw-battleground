export declare enum CardTextBuilderType {
    DEFAULT = 0,
    JADE_GOLEM = 1,
    ...
    REFERENCE_SCRIPT_DATA_NUM_1_NUM_2_ENTITY_POWER = 35,
    BATTLEGROUNDS_ZILLIAX = 36,
    SPELL_ABSORB = 37,
    ALT_TEXT_REFERENCE_SCRIPT_DATA_NUM_1_NUM_2_ENTITY_POWER = 38,
    REWIND_MECHANIC_CARD_TEXT_BUILDER = 39,
    BATTLEGROUNDS_TAVERN_SPELL = 40,
    DYNAMIC_KEYWORD = 41,
    REFERENCE_SCRIPT_DATA_NUM_1_CLASS = 42,
    HERALD = 43,
    ALTERNATE_CARD_TEXT_WITH_SCRIPT_DATA = 44,
    BATTLEGROUNDS_DEEP_BLUES_SPELL = 45
}
