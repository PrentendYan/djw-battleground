...
exports.NaturalBlessing = void 0;
...
const doMinionsShareType = (minion, target, allCards) => {
    var _a, _b;
    const minionTypes = (_a = allCards.getCard(minion.cardId).races) !== null && _a !== void 0 ? _a : [];
    const targetTypes = (_b = allCards.getCard(target.cardId).races) !== null && _b !== void 0 ? _b : [];
    return minionTypes.some((type) => targetTypes.includes(type));
};
//# sourceMappingURL=natural-blessing.js.map